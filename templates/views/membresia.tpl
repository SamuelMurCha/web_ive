...
<body>
    ...
    <main>
        ...
        <section class="section__form__main">
            <form action="{$base_url}/membresia/guardar" method="POST" class="form__general">
                        ...
                        <div class="group__input__general" id="input-areas">
                            ...
                            <div class="checkbox__list">
                                {foreach from=$equipos item=equipo}
                                    <label for="{$equipo.nombre}"><input type="checkbox" name="areas_servicio[]"
                                            id="{$equipo.nombre}">{$equipo.nombre}</label>
                                {/foreach}
                            </div>
                        </div>
                    </div>
